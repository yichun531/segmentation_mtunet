...
from dataset.dataset_STAS_pretrain import STASdataset, RandomGenerator
import argparse
from tqdm import tqdm
import os, sys, random
from torchvision import transforms
from utils.test_STAS import inference
from model.MTUNet_STAS import MTUNet_Pretrain
import numpy as np
...
train_dataset = pretrain_dataset(args.train_dir, args.test_dir, split="train", output_size=[args.img_size, args.img_size],
                            soft_label=args.soft_label, data_augment=args.data_augment, 
                            transform = transforms.Compose(
                                   [RandomGenerator(output_size=[args.img_size, args.img_size])]))
train_loader = DataLoader(train_dataset, batch_size=args.batch_size, shuffle=True)
db_val=STASdataset([args.train_dir, args.test_dir], split="valid", output_size=[args.img_size, args.img_size], 
